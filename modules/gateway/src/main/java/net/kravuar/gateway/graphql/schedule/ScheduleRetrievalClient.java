...
@ReactiveFeignClient(
        ...
        url = "http://schedule:8080/schedule/api-v1/retrieval"
)
interface ScheduleRetrievalClient {
    ...
    Flux<ScheduleByServiceDTO> byService(@PathVariable("serviceId") long serviceId, @PathVariable("from") LocalDate from, @PathVariable("to") LocalDate to);
